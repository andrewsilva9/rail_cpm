...
model = {'caffemodel': '/home/andrewsilva/Documents/rail_cpm/model/_trained_COCO/pose_iter_440000.caffemodel',
         'deployFile': '/home/andrewsilva/Documents/rail_cpm/model/_trained_COCO/pose_deploy.prototxt',
         ...
         'part_str': ['nose', 'neck', 'right_shoulder', 'right_elbow', 'right_wrist', 'left_shoulder', 'left_elbow',
                      'left_wrist', 'Rhip', 'Rkne', 'Rank', 'Lhip', 'Lkne', 'Lank', 'left_eye', 'right_eye', 'left_ear',
                      'right_ear', 'pt19']}
## Toss out 8 - 13
down_scale = 0.5
...
class PoseMachine:
    ...
    def estimate_keypoints(self, input_image):
        ...
        for n in (range(len(subset))):
            people.append({})
            # First 6 limb sequences include body parts that I want
            for i in range(6):
            ...
            # Last 6 limb sequences include body parts that I want
